...
- [ ] **8a — Lightbox Bug Fix**: Fix the bug where some images can't be viewed fully (only thumbnails appear). Ensure the lightbox scales correctly for all aspect ratios.
